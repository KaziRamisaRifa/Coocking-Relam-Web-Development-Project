...
<div class="main">
    <form name="LoginForms" class="" action="signupmain.php" method="POST" onsubmit="return validateForm();">

    <div id="name">
        <h2 class="name">Name</h2>
        <input class="firstname" type="text" name="first_name" value="" placeholder="Enter your first name"><br>
        <label class="firstlabel">first name</label>

        <input class="lastname" type="text" name="last_name" value="" placeholder="Enter your Last Name">
        <label class="lastlabel">last name</label>
    </div>


      <h2 class="name">Username</h2>
        <input class="username" type="text" name="username" value="" placeholder="Enter Username">
        ...
        <input class="code" type="number" name="area_code" value="" placeholder="area code">
        <label class="area-code">Area Code</label>
        <input class="number" type="number" name="phone" value="" placeholder="Enter your number">
